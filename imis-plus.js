...
var Utils = /** @class */ (function () {
    ...
    Utils.VERSION_STRING = "%c CSI %c iMIS Experience Plus! %c v1.3.6 %c ";
    return Utils;
}());
    ...
    WorkBar.prototype.prioritizePhones = function ($values) {
        ...
        if ($values.length > 0) {
            ...
            for (var _a = 0, $values_1 = $values; _a < $values_1.length; _a++) {
                var phone = $values_1[_a];
                if (prioritizedPhones.length >= 2)
                    break;
